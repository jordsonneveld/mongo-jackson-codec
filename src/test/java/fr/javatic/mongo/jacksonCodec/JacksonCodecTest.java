...
public class JacksonCodecTest {
  ...
  private static BsonDocument createBlogPostBson(String id, OffsetDateTime offsetDateTime) {
    ...
    expectedDocument.put("offsetDateTime",
        new BsonDateTime(offsetDateTime.toInstant().toEpochMilli()));
  ...
  public void testEncoding() {
    ...
    assertEquals(createBlogPostBson(blogPost.getId(), blogPost.getOffsetDateTime()),
        writer.getDocument());
  }
  ...
  public void testDecoding() {
    ...
    BsonDocumentReader reader =
        new BsonDocumentReader(createBlogPostBson(idValue, testOffsetDateTime));
    ...
    assertEquals(testOffsetDateTime.toInstant().toEpochMilli(),
        blogPost.getOffsetDateTime().toInstant().toEpochMilli());
  }
